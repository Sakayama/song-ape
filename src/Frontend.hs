...
validOrderAction = placeOrder [AlbumId "album1", AlbumId "album2", SongId "7", SongId "1a", SongId "a", SongId "z", SongId "1"]
...
showItem (AlbumDatagram album mArtist items price) =
